...
## [<img src="https://github.com/QuantLet/Styleguide-and-FAQ/blob/master/pictures/qloqo.png" alt="Visit QuantNet">](http://quantlet.de/) **CPAinsample** [<img src="https://github.com/QuantLet/Styleguide-and-FAQ/blob/master/pictures/QN2.png" width="60" alt="Visit QuantNet 2.0">](http://quantlet.de/)
...
PAM.fit = function(X, Y, n.years){
  ...
  while (m < M){
    ...
    q90     = quantile(MB.ratios.max, probs = 1-(0.1*m)/M)
    q95     = quantile(MB.ratios.max, probs = 1-(0.05*m)/M)
...
automatically created on 2019-11-27